"""cydsp CLI -- process, analyze, synthesize, and convert audio files."""
...
def cmd_info(args: argparse.Namespace) -> None:
    ...
    from cydsp.analysis import loudness_lufs
...
def _apply_chain(
    ...
    from cydsp._cli import apply_preset
...
def _run_analysis(subcmd: str, buf: AudioBuffer, args: argparse.Namespace):
    ...
    from cydsp import analysis as _analysis
...
def cmd_synth(args: argparse.Namespace) -> None:
    ...
    from cydsp import synthesis as _synthesis
    from cydsp.buffer import AudioBuffer
...
def cmd_convert(args: argparse.Namespace) -> None:
    ...
    from cydsp.analysis import resample
...
def cmd_preset(args: argparse.Namespace) -> None:
    ...
    from cydsp._cli import PRESETS, get_preset_categories, apply_preset
...
def cmd_pipe(args: argparse.Namespace) -> None:
    ...
    from cydsp.io import read_wav_bytes, write_wav_bytes
...
def cmd_benchmark(args: argparse.Namespace) -> None:
    ...
    from cydsp._cli import get_function, parse_fx_token, coerce_params
...
def cmd_list(args: argparse.Namespace) -> None:
    ...
    from cydsp._cli import get_categories, get_registry, format_signature
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="cydsp",
        description="cydsp - audio DSP toolkit",
    )
    parser.add_argument(
        "--version",
        action="version",
        version=f"cydsp {__version__}",
    )
