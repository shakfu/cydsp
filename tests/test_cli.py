...
from cydsp.__main__ import build_parser, main
...
class TestFormatSignature:
    ...
    def test_synthesis_fn(self):
        from cydsp.synthesis import oscillator
...
class TestCLIEndToEnd:
    ...
    def wav_file(self, tmp_path):
        ...
        from cydsp.io import write_wav
    ...
    def test_convert_to_mono(self, tmp_path):
        from cydsp.io import write_wav, read_wav
    ...
    def test_pipe_basic(self, tmp_path, monkeypatch):
        ...
        import io as _io
        from cydsp.io import write_wav_bytes, read_wav_bytes
    ...
    def test_wav_bytes_invalid_bit_depth(self):
        from cydsp.io import write_wav_bytes
